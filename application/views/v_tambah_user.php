<div class="form-container" style="max-width: 650px; margin: 30px auto 60px auto; padding: 0 15px;">
    ...
    <a href="<?= base_url('index.php/user'); ?>" style="text-decoration: none; color: #64748b; font-size: 14px; font-weight: 700; display: inline-flex; align-items: center; gap: 8px; margin-bottom: 25px; transition: all 0.3s ease; padding: 8px 16px; border-radius: 50px; background: #ffffff; box-shadow: 0 2px 5px rgba(0,0,0,0.02); border: 1px solid #f1f5f9;" onmouseover="this.style.color='#00b4d8'; this.style.transform='translateX(-3px)';" onmouseout="this.style.color='#64748b'; this.style.transform='translateX(0)';">
    ...
    <div class="card border-0 rounded-4" style="background: #ffffff; border-radius: 24px; box-shadow: 0 30px 60px -15px rgba(15, 23, 42, 0.08); border: 1px solid rgba(226, 232, 240, 0.7); overflow: hidden;">
        ...
        <div class="form-header" style="background: linear-gradient(135deg, #0f172a, #1e293b); padding: 30px 40px; position: relative;">
            ...
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div>
                    <h4 class="mb-1" style="font-size: 1.35rem; font-weight: 800; color: #ffffff; letter-spacing: -0.5px;">Tambah User Baru</h4>
                    <p class="mb-0" style="font-size: 13px; color: #94a3b8; font-weight: 500;">Input kredensial dan hak akses akun baru ke dalam sistem</p>
                </div>
            </div>
        </div>

        <form action="<?= base_url('index.php/user/simpan'); ?>" method="post" style="padding: 40px; display: flex; flex-direction: column; gap: 25px; background: #ffffff;">
            ...
            <div class="input-group-custom" style="display: flex; flex-direction: column; gap: 8px;">
                <label style="font-size: 12px; font-weight: 800; color: #4a5568; text-transform: uppercase; letter-spacing: 1px;">
                    Username / NIM <span style="color: #ef4444;">*</span>
                </label>
            ...
            <div class="input-group-custom" style="display: flex; flex-direction: column; gap: 8px;">
                <label style="font-size: 12px; font-weight: 800; color: #4a5568; text-transform: uppercase; letter-spacing: 1px;">
                    Role / Jabatan Akses <span style="color: #ef4444;">*</span>
                </label>
                <div style="position: relative; display: flex; align-items: center;">
                    <i class="fa-solid fa-user-shield" style="position: absolute; left: 18px; color: #94a3b8; font-size: 15px; z-index: 10;"></i>
                    <select name="role" required 
                            style="width: 100%; padding: 14px 16px 14px 48px; border: 1px solid #e2e8f0; border-radius: 12px; outline: none; font-size: 14px; font-weight: 600; color: #1e293b; background: #f8fafc; cursor: pointer; appearance: none; transition: all 0.3s ease;"
                            onfocus="this.style.borderColor='#00b4d8'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 4px rgba(0,180,216,0.15)';" 
                            onblur="this.style.borderColor='#e2e8f0'; this.style.background='#f8fafc'; this.style.boxShadow='none';">
